...
class StaffBase(BaseModel):
    ...
    departments: list[str] = Field(..., min_length=1, description="担当フロア")
    ...
    def validate_departments(cls, value: list[str]) -> list[str]:
        ...
        if not cleaned:
            raise ValueError("担当フロアを1つ以上選択してください。")
...
class StaffUpdate(BaseModel):
    ...
    departments: list[str] | None = Field(default=None, min_length=1, description="担当フロア")
